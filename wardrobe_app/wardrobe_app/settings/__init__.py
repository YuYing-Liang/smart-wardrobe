"""
Django settings for wardrobe_app project.
...
ROOT_URLCONF = "wardrobe_app.urls"
...
TEMPLATES = [
    {
        ...
        "DIRS": [],
        "APP_DIRS": True,
        "OPTIONS": {"environment": "wardrobe_app.jinja2.environment"},
    },
    {
...
# LOGIN_REDIRECT_URL = reverse_lazy("event:client")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "wardrobe_app"),
